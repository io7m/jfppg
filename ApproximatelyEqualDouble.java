...
public final class ApproximatelyEqualDouble
{
  ...
  public static boolean approximatelyEqual(final double x,
                                           final double y)
  {
    return ApproximatelyEqualDouble.approximatelyEqualExplicit(x, y, ApproximatelyEqualDouble.DOUBLE_ERROR);
  }
  ...
  public static boolean approximatelyEqualExplicit(final double x,
                                                   final double y,
                                                   final double e)
  {
    if (x == y) {
